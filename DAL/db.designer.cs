...
namespace SalesWithLinq.DAL
{
    ...
    partial void OnIDChanging(int value);
    partial void OnIDChanged();
    partial void OnInoiceIDChanging(int value);
    partial void OnInoiceIDChanged();
    ...
    partial void OnStoreIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_InoiceID", DbType="Int NOT NULL")]
		public int InoiceID
		{
			get
			{
				return this._InoiceID;
			}
			set
			{
				if ((this._InoiceID != value))
				{
					this.OnInoiceIDChanging(value);
					this.SendPropertyChanging();
					this._InoiceID = value;
					this.SendPropertyChanged("InoiceID");
					this.OnInoiceIDChanged();
				}
			}
		}
